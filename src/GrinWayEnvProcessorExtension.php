...
use GrinWay\EnvProcessor\Configuration;
...
use GrinWay\EnvProcessor\DependencyInjection\IsAbsolutePathVarProcessor;
use GrinWay\EnvProcessor\DependencyInjection\IsExistsPathVarProcessor;
use GrinWay\EnvProcessor\DependencyInjection\NormalizePathEnvVarProcessor;
use GrinWay\EnvProcessor\DependencyInjection\RTrimVarProcessor;
use GrinWay\EnvProcessor\DependencyInjection\IsExistsFileVarProcessor;

class GrinWayEnvProcessorExtension extends ConfigurableExtension implements PrependExtensionInterface
{
    public const PREFIX = 'grin_way_env_processor';
    ...
    */
    ...
    private function registerEnvProcessors(
        ...
        $container
            ->registerForAutoconfiguration(GrinWayEnvProcessorInterface::class)
