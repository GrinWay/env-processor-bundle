 ...
 */
class AssertPathExistsVarProcessor extends AbstractEnvProcessor
{
    public const ENV_PROCESSOR_NAME = 'assert_path_exists';
    ...
    ): mixed
    {
        ...
        if (!\file_exists($path)) {
            throw new PathNonExistentVarProcessorException(
